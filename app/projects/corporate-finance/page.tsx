...
function ProjectCard({ title, description, image, slug, github, tags }: any) {
  return (
    <Link href={`/projects/corporate-finance/${slug}`} className="block h-full">
      <motion.div
...
export default function CorporateFinancePage() {
  return (
    <main className="min-h-screen px-4 py-16">
      <h1 className="text-4xl font-bold text-center mb-12">Corporate Finance Projects</h1>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        <ProjectCard
          title="10-K Financial Summary Analyzer"
          description="Extracts and visualizes key metrics from SEC 10-K filings."
          image="/10k-analysis.jpg"
          slug="10k-analyzer"
          github="https://github.com/AlexMcNicholl"
          tags={["SEC", "EDGAR", "Python", "XBRL"]}
        />
        <ProjectCard
          title="Capital Budgeting App"
          description="Tool for evaluating investment projects using NPV and IRR analysis."
          image="/capital-budgeting.jpg"
          slug="capital-budgeting"
          github="https://github.com/AlexMcNicholl"
          tags={["Finance", "NPV", "IRR", "React"]}
        />
      </div>
